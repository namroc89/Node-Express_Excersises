...
describe("GET /users/:username", function () {
  ...
  test("unauth for other user", async function () {
    const resp = await request(app)
      .get(`/users/u1`)
      .set("authorization", `Bearer 1232131ewdssads`);
    expect(resp.statusCode).toEqual(401);
  });
...
describe("PATCH /users/:username", () => {
  ...
  test("unauth for other users", async function () {
    const resp = await request(app)
      ...
      .set("authorization", `Bearer 123ewrsfs`);
    expect(resp.statusCode).toEqual(401);
  });
...
describe("DELETE /users/:username", function () {
  test("works for matched user", async function () {
    const resp = await request(app)
      .delete(`/users/u1`)
      .set("authorization", `Bearer ${u1Token}`);
  ...
  test("unauth if another user", async function () {
    const resp = await request(app)
      .delete(`/users/u1`)
      .set("authorization", `Bearer dsfwr345r`);
    expect(resp.statusCode).toEqual(401);
  });
